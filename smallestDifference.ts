...
function smallestDifference(arr1: Array<number>, arr2: Array<number>): [number, number] {
  arr1.sort((a, b) => a - b);
  arr2.sort((a, b) => a - b);
  ...
  let pair: [number, number] = [arr1[i], arr2[j]];
...
assertArrayEquals(
  smallestDifference([1, 100, 200, 400, 300], [4, 5, 6, 7, 8, 9, 10, 49, 38, 392]),
  [1, 4]
);
assertArrayEquals(
  smallestDifference([1, 2, 3, 10, 20, 30, 49, 69, 98, 200], [100, 129, 200, 300]),
  [200, 200]
);
